...
ActiveRecord::Schema.define(:version => 20131023205228) do
  ...
  create_table "categories", :force => true do |t|
    ...
    t.timestamp "avatar_updated_at",   :limit => 6
    t.timestamp "created_at",          :limit => 6, :null => false
    t.timestamp "updated_at",          :limit => 6, :null => false
  end
  ...
  create_table "payloads", :force => true do |t|
    ...
    t.timestamp "payload_updated_at",   :limit => 6
  ...
  create_table "users", :force => true do |t|
    ...
    t.timestamp "identity_unlocked_at",         :limit => 6, :default => '1970-01-01 01:01:00', :null => false
    t.text      "about"
