...
ActiveRecord::Schema.define(version: 20140312131510) do
  ...
  create_table "article_goals", force: true do |t|
    t.integer "article_id"
    t.integer "goal_id"
  end
  ...
  create_table "articles", force: true do |t|
    ...
    t.string   "author"
    t.text     "original_url"
    t.boolean  "drip_content"
    t.integer  "reveal_after_days"
  end
  ...
  create_table "courses", force: true do |t|
    ...
    t.integer  "image_file_size"
    t.datetime "image_updated_at"
    t.boolean  "roger_love",                                         default: false
  end
  ...
  create_table "request_records", force: true do |t|
    t.string   "session_id"
    t.integer  "user_id"
  ...
  create_table "stripe_webhook_calls", force: true do |t|
    t.text     "params"
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "ordered_workbook",             default: false
    t.boolean  "ordered_action_sidekick",      default: false
  end
