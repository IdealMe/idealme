...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { avatar: @market.avatar, hidden: @market.hidden, name: @market.name, slug: @market.slug }
    end
  ...
  test "should update market" do
    put :update, id: @market, market: { avatar: @market.avatar, hidden: @market.hidden, name: @market.name, slug: @market.slug }
    assert_redirected_to market_path(assigns(:market))
  end
